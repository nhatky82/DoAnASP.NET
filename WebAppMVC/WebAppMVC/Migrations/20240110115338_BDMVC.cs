...
{
    public partial class BDMVC : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    LinkEbook = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoices_PaymentMethods_PaymentMethodsID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetailCombos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetailCombos_Combos_comboID",
                        column: x => x.comboID,
                        principalTable: "Combos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetailCombos_Products_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SumStar = table.Column<int>(type: "int", nullable: false),
                    UserID = table.Column<int>(type: "int", nullable: false),
                    ProductID = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetailCombos_comboID",
                table: "DetailCombos",
                column: "comboID");

            migrationBuilder.CreateIndex(
                name: "IX_DetailCombos_ProductID",
                table: "DetailCombos",
                column: "ProductID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoices_PaymentMethodsID",
                table: "Invoices",
